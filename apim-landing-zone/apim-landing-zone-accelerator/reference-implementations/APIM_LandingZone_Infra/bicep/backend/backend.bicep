...
@description('Toggle to enable/disable the deployment of Azure Function')
@allowed([
  'true'
  'false'
])
param deployFunction string = 'false'
...
// Azure Application Service Plan
resource serverfarms_appsvcplanAPIMCSBackend_name_resource 'Microsoft.Web/serverfarms@2018-02-01' = if(deployFunction == 'true'){
...
resource sites_funcappAPIMCSBackendMicroServiceA_name_resource 'Microsoft.Web/sites@2018-11-01' = if(deployFunction == 'true'){
...
resource sites_funcappAPIMCSBackendMicroServiceA_name_sites_funcappAPIMCSBackendMicroServiceA_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2018-11-01' = if(deployFunction == 'true'){
...
resource planNetworkConfig 'Microsoft.Web/sites/networkConfig@2021-01-01' = if(deployFunction == 'true'){
  parent: sites_funcappAPIMCSBackendMicroServiceA_name_resource
  name: 'virtualNetwork'
  properties: {
...
resource privateEndpoint 'Microsoft.Network/privateEndpoints@2021-03-01' = if(deployFunction == 'true'){
...
resource privateDnsZones 'Microsoft.Network/privateDnsZones@2018-09-01' = if(deployFunction == 'true'){
  name: privateDNSZoneName
  location: 'global'
}

resource privateDnsZoneLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2018-09-01' = if(deployFunction == 'true'){
...
resource privateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2020-03-01' = if(deployFunction == 'true'){
