...
module newCertificate './modules/certificate.bicep' ={
  name: 'certificate'
  ...
  params: {
    ...
    managedIdentityId: appGwManagedIdentityId
  }
}
    ...
    sslCertificates: [
      {
        name: appGatewayFQDN
        properties: {
          //keyVaultSecretId: newOrExistingKeyVault == 'new' ? newCertificate.outputs.secretUri : existingCertificate.outputs.secretUri
          keyVaultSecretId: newCertificate.outputs.secretUri
        }
      }
    ]
    sslPolicy: {
